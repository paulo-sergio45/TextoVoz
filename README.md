...
- O reprodutor de áudio possui funções parar é iniciar.
...
2.5º publish Visual Studio.

Ou através do link: [learn microsoft](https://learn.microsoft.com/en-us/dotnet/maui/android/deployment/publish-ad-hoc?view=net-maui-9.0)
